...
SECRET_KEY = '$p7v^)cx972&!d^ei63v%t&(x6)fd7w)wz_ytg#4c1p%g_t#v5'
...
INSTALLED_APPS = [
    ...
    'Recognise.apps.RecogniseConfig'
]
...
#OUT = os.path.join(MEDIA_URL, "source/output")
VID = os.path.join(MEDIA_URL, "videos")
#FILES_DIR = os.path.abspath(os.path.join(BASE_DIR, '/info'))
SRC = os.path.abspath( os.path.join(MEDIA_ROOT, "source"))
